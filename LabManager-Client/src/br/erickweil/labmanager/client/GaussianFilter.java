...
public class GaussianFilter {// extends ConvolveFilter {
    ...
    private static int CLAMP_EDGES;
    private static int WRAP_EDGES;
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
        ...
        convolveAndTranspose(kernel, inPixels, outPixels, width, height, false, CLAMP_EDGES);
        convolveAndTranspose(kernel, outPixels, inPixels, height, width, false, CLAMP_EDGES);
